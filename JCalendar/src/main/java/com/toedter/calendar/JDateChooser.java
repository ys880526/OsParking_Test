 ...
 */
/**
 * Partly Modified by Open Source Parking Inc. on Oct. 08, 2015.
 * See lines 207, 231, -- search key: osparking
 */
...
public class JDateChooser extends JPanel implements ActionListener,
	...
	public JDateChooser(JCalendar jcal, Date date, String dateFormatString,
		...
		setDate(date);
                            ...
                            // : following 3 lines changed by osparking
                // Display a calendar button with an icon                   :  Before Change
                            // URL iconURL = getClass().getResource(
                            //      "/com/toedter/calendar/images/JDateChooserIcon.gif");
                            //      ImageIcon icon = new ImageIcon(iconURL);
	 // Display a calendar button with an icon                      : After Change
		URL iconURL = getClass().getResource("/JDateChooserColor32.gif");
                                    ImageIcon icon = new ImageIcon(((new ImageIcon(iconURL)).getImage())
                                            .getScaledInstance(32, 32, java.awt.Image.SCALE_SMOOTH));
                            // Change ends here
                                    
		calendarButton = new JButton(icon) { // 2.
		...
		calendarButton.setMargin(new Insets(0, 0, 0, 0));
                // : following 3 lines added by osparking
                        calendarButton.setMinimumSize(new Dimension(35,33));
                        calendarButton.setPreferredSize(new Dimension(35,33));
                        calendarButton.setMaximumSize(new Dimension(35,33));
                // Addition ends here
